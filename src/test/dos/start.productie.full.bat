...
%JAVA_HOME%\bin\java %JAVA_OPTS% -cp N:\Collectieinformatie\_Applicatiebeheer\pids\target\pid-1.0.jar org.rijksmuseum.pid.PidRequests --endpoint %ENDPOINT% --key %WSKEY% --file N:\Collectieinformatie\_Applicatiebeheer\pids\src\test\dos\pidsfull.xml